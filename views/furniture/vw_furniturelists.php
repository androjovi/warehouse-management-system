          ...
          <table class="table table-bordered" id="table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><?php echo $k->nama_furniture; ?></td>
                <td style="text-align: center;"><a href="<?php echo site_url('furniture/delete/'.$k->id_furniture); ?>" onclick="return confirm_hapus()" class="btn btn-danger btn-sm">Hapus</a>&nbsp;
                  <a href="<?php echo site_url('furniture/edit/'. $k->id_furniture); ?>" class="btn btn-success btn-sm">Update</a>&nbsp;
                  <a href="javascript:void(0)" data-user="<?php echo $k->id_furniture; ?>" class="btn btn-warning btn-sm details_user">Lihat</a>
                </td>
              </tr>
            <?php endforeach; ?>
            </tbody>
...
$.ajax({
  type: "get",
  url : "<?php echo base_url() ?>furniture/show/"+t,
  dataType: "json",
  success: function(data){
    //$.each(data, function(n, j){
            $(".modal-body").html('<p>Deskripsi : '+data.deskripsi+'</p>Image furniture <br><img width="150" height="150" src="<?php echo base_url() ?>upload_/'+data.image+'"></img>')
    //})
      $("#myModal").modal('show');
  }
})
