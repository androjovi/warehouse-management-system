  ...
  <div class="row">
      ...
      <div class="col-md-12">
        ...
        <div class="box box-primary">
          ...
          <!-- /.box-header -->
          <!-- form start -->
          <form class="form-horizontal" method="post" action="<?php echo site_url('furniture/insert_furniture') ?>" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
                  <label class="col-sm-2 control-label">ID Furniture</label>

                  <div class="col-sm-10">
                    <input type="number" name="id_furniture" class="form-control" placeholder="ID Furniture">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <textarea name="deskripsi_furniture" style="resize:none;height:50%;" class="form-control" placeholder="Max 100 Characters"></textarea>
                  </div>
                </div>
                <div class="form-group">
                ...
                <img id="blah" src="#" width="150" height="150" alt="preview Image furniture">
