  ...
  <div class="row">
      ...
      <div class="col-md-12">
        ...
        <div class="box box-primary">
          ...
          <!-- /.box-header -->
          <!-- form start -->
          <form class="form-horizontal" method="post" action="<?php echo site_url('gudang/insert') ?>">
              <div class="box-body">
                <div class="form-group">
                  <label class="col-sm-2 control-label">ID Penyimpanan</label>

                  <div class="col-sm-10">
                    <input type="number" name="id_penyimpanan" class="form-control" placeholder="ID Peyimpanan">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select class="form-control selectpicker" name="id_perusahaan" data-live-search="true">
                      ...
                      <option data-tokens="<?php echo $k->id_perusahaan ?>"><?php echo $k->id_perusahaan ?></option>
                    <?php endforeach; ?>
                    </select>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="batas_max" class="form-control" placeholder="Batas max">
                  </div>
                </div>
